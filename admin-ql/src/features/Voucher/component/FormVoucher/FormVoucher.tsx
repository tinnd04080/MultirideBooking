      ...
      >
        ...
        >
          <Input
            ...
            style={{ textTransform: 'uppercase' }} // Tất cả chữ nhập vào sẽ thành chữ hoa
          />
        </Form.Item>
        <Form.Item
          className='dark:text-white'
          label='Tỷ lệ phần trăm giảm'
          name='discountAmount'
          rules={[
        ...
        <Form.Item
          className='dark:text-white'
          label='Số lượng mã sẽ được phát hành'
          name='quantity'
          rules={[
            { required: true, message: 'Không được bỏ trống!' },
            {
        ...
        >
          <Select placeholder='Kiểu' size='large'>
            <Select.Option value='PERCENT'>
              <span className='text-sm capitalize'>Phần trăm</span>
            </Select.Option>
          </Select>
        </Form.Item>
        ...
        >
          <Select placeholder='Vui lòng chọn trạng thái'>
            ...
            <Select.Option value={'EXPIRED'}>Ngừng hoạt động</Select.Option>
          </Select>
        </Form.Item>
        <Form.Item
          className='dark:text-white'
