...
var TripController = {
  ...
  createTrip: function createTrip(req, res) {
    var _req$body, route, bus, departureTime, arrivalTime, status, busInfo, busRouteInfo, overlappingTrips, rawPrice, ticketPrice, trip, seatCapacity, seats, i, seatNumber, halfCapacity, _i, _seatNumber, _i2, _seatNumber2;
    ...
    return regeneratorRuntime.async(function createTrip$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 16:
            overlappingTrips = _context.sent;
          ...
          case 19:
            ...
            rawPrice = busRouteInfo.distance * busRouteInfo.pricePerKM * busInfo.priceFactor;
            console.log("Raw Price (before rounding):", rawPrice); // Làm tròn giá vé thành bội số của 10.000

            ticketPrice = Math.round(rawPrice / 10000) * 10000;
            console.log("Final Ticket Price (after rounding):", ticketPrice); // Tạo chuyến xe
