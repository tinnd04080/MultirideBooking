...
var BusRouteController = {
  ...
  createBusRoutes: function createBusRoutes(req, res) {
    var _req$body, startProvince, startDistrict, endDistrict, endProvince, duration, status, distance, pricePerKM, existingRoute, busRoute;
    ...
    return regeneratorRuntime.async(function createBusRoutes$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _req$body = req.body, startProvince = _req$body.startProvince, startDistrict = _req$body.startDistrict, endDistrict = _req$body.endDistrict, endProvince = _req$body.endProvince, duration = _req$body.duration, status = _req$body.status, distance = _req$body.distance, pricePerKM = _req$body.pricePerKM; // Kiểm tra xem tuyến xe đã tồn tại hay chưa
  ...
  getBusRoutes: function getBusRoutes(req, res) {
    var _req$query, _req$query$page, page, _req$query$limit, limit, startProvince, startDistrict, endProvince, endDistrict, status, duration, queryObj, busRoutes, count, totalPage, currentPage;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            if (duration) {
              queryObj.duration = {
                $gte: (0, _dayjs["default"])(duration).startOf("day").toDate(),
                $lte: (0, _dayjs["default"])(duration).endOf("day").toDate()
              };
            }
